...
##
## Job report script to send pop up message to currently logged in user (JobReport)
##------------------------------------------------------------
...
def __main__():
    ...
    selectedReports = MonitorUtils.GetSelectedJobReports()
    ...
    if len(machineNames) > 0:
        ...
        # Call the main Send Pop Up Message script and pass the list of machine names.
